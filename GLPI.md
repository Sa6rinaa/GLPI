...
![](images/34.png)   ![](images/35.png)   ![](images/36.png)   ![](images/37.png) 
...
> Double-cliquez sur le lien afin de lancer l'installation et suivez l'assistant d'installation comme ci-dessous: 
 ...
 ![](images/23.png) ![](images/24.png) ![](images/22.png) 
...
![](images/25.png) ![](images/44.png)  ![](images/26.png) ![](images/27.png) ![](images/28.png)
...
![](images/39.png) --> Choisir le contact/fournisseur/contrat que vous souhaitez créer,


![](images/40.png) --> Dans cette exemple je créer un contrat , pour le créer il faut cliquer un haut de votre page sur "+ Ajouter".



![](images/41.png) --> Ensuite créer votre contrat avec les informations que vous possédez et cliquer sur bouton "+ ajouter" en jaune en bas droite de votre écran.
